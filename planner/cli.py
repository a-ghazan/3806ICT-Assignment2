# ----------------------------------------------------------------------------------------------------------
# planner/cli.py
# This is mostly a command line wrapper, this does not generate proofs itself. Main function is to collect
# settings from the command line and then call plan_and_fill from planner.driver which contains the main
# planner logic
# ----------------------------------------------------------------------------------------------------------
